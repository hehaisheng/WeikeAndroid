...
public class ToastLayout extends RelativeLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            int statusBarHeight = getResources().getDimensionPixelSize(R.dimen.action_button_height);
            ...
            int height = statusBarHeight +
                    getResources().getDimensionPixelSize(R.dimen.action_button_height);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int shadowHeight = getResources().getDimensionPixelSize(R.dimen.action_button_height);
