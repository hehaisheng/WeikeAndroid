...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
    private List<ClientSortModel> list = null;
    private Context mContext;

    public SortAdapter(Context mContext, List<ClientSortModel> list) {
     ...
     * @param list
     */
    public void updateListView(List<ClientSortModel> list) {
        this.list = list;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final ClientSortModel mContent = list.get(position);
        if (view == null) {
